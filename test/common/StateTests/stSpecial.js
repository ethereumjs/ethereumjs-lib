var stSpecial = require('ethereum-tests').StateTests.stSpecial,
  async = require('async'),
  VM = require('../../../lib/vm'),
...
describe('[Common]: stSpecial', function () {
  var tests = Object.keys(stSpecial);

  tests.forEach(function(testKey) {
    var state = new Trie();
    var testData = stSpecial[testKey];
