...
describe('trie', function(){
  ...
  describe('#rootHash', function (argument) {
    it('basic', function () {
      ...
      trie.update('a', 'A');
      trie.update('b', 'B');
      trie.rootHash().should.equal('300eab197a9d9e437aaeb9b0d7bd77d57e8d4e3eeca0b1e6a3fe28a84e2cd70c');
    });

    it('basic1', function () {
      var trie = new Trie.Trie(undefined, '');
      trie.update('test', 'test');
      trie.rootHash().should.equal('85d106d4edff3b7a4889e91251d0a87d7c17a1dda648ebdba8c6060825be23b8');
    });
    ...
    it('basic2', function () {
      ...
      trie.rootHash().should.equal('8452568af70d8d140f58d941338542f645fcca50094b20f3c3d8c3df49337928');
    });
    ...
    it('do prefix', function () {
      ...
      trie.rootHash().should.equal('8aad789dff2f538bca5d8ea56e8abe10f4c7ba3a5dea95fea4cd6e7c3a1168d3');
    });
    ...
    it('be prefix', function () {
      ...
      trie.update('dog', 'puppy');
      trie.update('bed', 'd');
      trie.rootHash().should.equal('3f67c7a47520f79faa29255d2d3c084a7a6df0453116ed7232ff10277a8be68b');
    });
    ...
    it('multiprefix', function () {
      ...
      trie.rootHash().should.eql('5991bb8c6514148a29db676a14ac506cd2cd5775ace63c30a4fe457715e9ac84');
    });
    ...
    it('replacement', function () {
      ...
      trie.rootHash().should.equal('17beaa1648bafa633cda809c90c04af50fc8aed3cb40d16efbddee6fdf63c4c3');
    });
  });
});
