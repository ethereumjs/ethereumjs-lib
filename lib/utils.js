...
exports.MAX_INTERGER = bignum('ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16);
...
exports.pubToAddress = function (pubKey) {
  ...
  var recoveredKey = pubKey.getEncoded(false),
  hash = new SHA3.SHA3Hash(256);

  hash.update(recoveredKey.slice(1));
