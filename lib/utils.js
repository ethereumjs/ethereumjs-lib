 ...
 * If array has more than 160 bits, returns the last 160 bits.
 * @method pad160
 * @param {Buffer|Array}
 * @return {Buffer|Array}
 */
...
exports.fromSigned = function(num) {
  if (num.bitLength() === 256) {
    return num.xor(exports.MAX_INTEGER).add(1).mod(256).neg();
  } else {
    return num;
  }
};
...
exports.toUnsigned = function(num) {
  if (num.lt(0)) {
    return num.neg().xor(exports.MAX_INTEGER).add(1).mod(256);
  } else {
    return num;
  }
};
