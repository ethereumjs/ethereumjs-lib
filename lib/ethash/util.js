...
exports.getCacheSize = function(blockNumber){
  var sz = param.DATASET_BYTES_INIT + param.DATASET_BYTES_GROWTH * Math.floor(block_number / param.EPOCH_LENGTH)
  sz -= HASH_BYTES
...
exports.getFullSize = function(blockNumber){
  var sz = param.CACHE_BYTES_INIT + param.CACHE_BYTES_GROWTH * Math.floor(block_number / param.EPOCH_LENGTH)
  sz -= param.MIX_BYTES
