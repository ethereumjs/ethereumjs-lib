...
const ERROR = constants.ERROR,
  TT256 = bignum('115792089237316195423570985008687907853269984665640564039457584007913129639936');
...
module.exports = function(opts, cb) {
  ...
  function makeCall(callOptions, localOpts, done) {
    ...
    var data = memLoad(localOpts.inOffset, localOpts.inLength),
      err = null;
    ...
    if (depth >= constants.MAX_CALL_DEPTH || gasLeft.lt(callOptions.gas) || err === ERROR.OUT_OF_GAS || data === ERROR.OUT_OF_GAS) {
  ...
  async.whilst(function() {
    ...
    //revert the state if the contract runs out of gas
